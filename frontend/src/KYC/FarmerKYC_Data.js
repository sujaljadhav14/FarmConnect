        ...
        <div className="row">
          ...
          <div className="col-md-9 col-lg-10">
            <div className="card shadow p-4 col-md-8">
              <h3 className="text-success mb-3">🪪 My KYC Details</h3>
              ...
              {status === "not_submitted" && (
                <div className="alert alert-info">
                  ...
                  <div className="mt-3">
                    <Link to="/farmer/kyc" className="btn btn-success">
                      Submit KYC
                    </Link>
                  </div>
                </div>
                ...
                <>
                  ...
                  {status === "approved" && (
                    <div className="alert alert-success">
                      ✅ Your KYC is approved. You can access all features.
                    </div>
                  )}
                  ...
                  <ul className="list-group">
                    ...
                    {kyc.landProof && (
                      <DocumentItem label="Land Proof" file={kyc.landProof} />
                    )}

                    {kyc.gst && <DocumentItem label="GST" file={kyc.gst} />}
                  </ul>

                  {/* RESUBMIT */}
                  {status === "rejected" && (
                    <div className="text-center mt-4">
                      <Link to="/farmer/kyc" className="btn btn-danger">
                        Re-submit KYC
                      </Link>
                    </div>
                  )}
